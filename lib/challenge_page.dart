...
Livestudents livestudentsFromJson(String str) => Livestudents.fromJson(json.decode(str));
          ...
          if(snapshot.hasData){
            if(SubjectList.isEmpty)
              for(var j=0;j<snapshot.data!.data1.subjects.length;j++)
                SubjectList.add(snapshot.data!.data1.subjects[j].subjectName.toString());
            return Scaffold(
                    ...
                    Container(
                      ...
                      child: Column(
                        children: [
                              ...
                              return Container(
                                ...
                                child: InputDecorator(
                                  decoration: InputDecoration(
                                    //labelText: 'Subject',
                                      prefixIcon: Icon(Icons.subject,color: Colors.teal),
                                  ...
                                  child: DropdownButtonHideUnderline(
                                      child: DropdownButton(
                                        ...
                                        onChanged: (String? val) {
                                          for(var k=0;k<snapshot.data!.data1.subjects.length;k++)
                                            if(snapshot.data!.data1.subjects[k].subjectName==val)
                                              idSub=snapshot.data!.data1.subjects[k].id.toString();
                          ...
                          if(_dropDownValue!="")
                            FutureBuilder(
                                future: getLiveSubjects(idclass, idSub),
                                builder: (context, AsyncSnapshot<K12Card> snapshot1) {
                                  if(snapshot1.hasData){
                                    List <String> Booklist=[];
                                    for(var k=0;k<snapshot1.data!.data2.k12.length;k++)
                                      Booklist.add(snapshot1.data!.data2.k12[k].courseName.toString());
                                      ...
                                      builder: (FormFieldState<String> state) {
                                        ...
                                        return Container(
                                          ...
                                          child: InputDecorator(
                                            decoration: InputDecoration(
                                              //labelText: 'CLASS',
                                                prefixIcon: Icon(Icons.menu_book_sharp,color: Colors.teal),
                                                labelStyle: TextStyle(fontFamily: "Candara",fontSize: 16),
                                                errorStyle: TextStyle(fontFamily:"Candara",color: Colors.redAccent, fontSize: 16.0),
                                                //hintText: 'Please select expense',
                                                enabledBorder:OutlineInputBorder(
                                                    borderSide: const BorderSide(color: Colors.grey, width: 2.0),
                                            ...
                                            child: DropdownButtonHideUnderline(
                                                child: DropdownButton(
                                                  ...
                                                  onChanged: (String? val) {
                                                    for(var k=0;k<snapshot1.data!.data2.k12.length;k++)
                                                      if(snapshot1.data!.data2.k12[k].courseName==val)
                                                        idbook=snapshot1.data!.data2.k12[k].id.toString();
                                                      debugPrint(idbook);
                                                    setState(() {
                                                      _dropDownValue1 = val!;
                                                      _dropDownValue2="";
                          ...
                          if(_dropDownValue1!="")
                            FutureBuilder(
                                ...
                                builder: (context, AsyncSnapshot<K12Api> snapshot2) {
                                  if(snapshot2.hasData){
                                    List <String> ChapList=[];
                                    for(var k=0;k<snapshot2.data!.data.k12Details.length;k++)
                                      ChapList.add(snapshot2.data!.data.k12Details[k].chapterName.toString());
                                    return FormField<String>(
                                      builder: (FormFieldState<String> state) {
                                        String _currentSelectedValue='';
                                        return Container(
                                          ...
                                          child: InputDecorator(
                                            decoration: InputDecoration(
                                              //labelText: 'CLASS',
                                                prefixIcon: Icon(Icons.book_rounded,color: Colors.teal,size: 20,),
                                                labelStyle: TextStyle(fontFamily: "Candara"),
                                                errorStyle: TextStyle(fontFamily:"Candara",color: Colors.redAccent, fontSize: 16.0),
                                                //hintText: 'Please select expense',
                                                enabledBorder:OutlineInputBorder(
                                            ...
                                            child: DropdownButtonHideUnderline(
                                                child: DropdownButton(
                                                  ...
                                                  onChanged: (String? val) {
                                                    for(var k=0;k<snapshot2.data!.data.k12Details.length;k++)
                                                      if(snapshot2.data!.data.k12Details[k].chapterName==val)
                                                        idchap=snapshot2.data!.data.k12Details[k].id.toString();
                                                    setState(() {
                                                      _dropDownValue2 = val!;
                                                      _dropDownValue3 = "";
                                                    });
                          ...
                          if(_dropDownValue2!="")
                            FutureBuilder(
                                ...
                                builder: (context, AsyncSnapshot<K12Chapter> snapshot3) {
                                  if(snapshot3.hasData){
                                    List <String> qtList=[];
                                    for(var k=0;k<snapshot3.data!.data3.questionTypes.length;k++)
                                      qtList.add(snapshot3.data!.data3.questionTypes[k].catName.toString());
                                    return FormField<String>(
                                      builder: (FormFieldState<String> state) {
                                        String _currentSelectedValue='';
                                        return Container(
                                          ...
                                          child: InputDecorator(
                                            decoration: InputDecoration(
                                              //labelText: 'CLASS',
                                                prefixIcon: Icon(Icons.list_alt,color: Colors.teal,size: 20,),
                                                labelStyle: TextStyle(fontFamily: "Candara"),
                                                errorStyle: TextStyle(fontFamily:"Candara",color: Colors.redAccent, fontSize: 16.0),
                                                //hintText: 'Please select expense',
                                                enabledBorder:OutlineInputBorder(
                                            ...
                                            child: DropdownButtonHideUnderline(
                                                child: DropdownButton(
                                                  ...
                                                  onChanged: (String? val) {
                                                    for(var k=0;k<snapshot3.data!.data3.questionTypes.length;k++)
                                                      if(snapshot3.data!.data3.questionTypes[k].catName.toString()==val)
                                                        idqt=snapshot3.data!.data3.questionTypes[k].id.toString();
                                                    setState(() {
                                                      _dropDownValue3 = val!;
                                                    });
                          ...
                          for(var i =0;i<snapshot.data!.data1.student.length;i++)
                            Container(
                                ...
                                Padding(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                          ...
                                          child: Container(
                                            child: CircleAvatar(
                                              backgroundColor: Colors.amber,
                                                backgroundImage: NetworkImage("http://ec2-13-234-116-155.ap-south-1.compute.amazonaws.com/uploads/${snapshot.data!.data1.student[i].img.toString()}")
                                            ),
                                          )),
                                      SizedBox(
                                        width: 10,
                                      ...
                                      if(_dropDownValue!="" && _dropDownValue1!="" && _dropDownValue2!="" && _dropDownValue3!="")
                                        Expanded(
                                          flex: 3,
                                          child: SizedBox(
                                            height: 30,
