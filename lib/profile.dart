...
class Data {
  ...
  factory Data.fromJson(Map<String, dynamic> json) => Data(
    ...
    mentees: List<Mentee>.from(json["mentees"].map((x) => Mentee.fromJson(x))),
  );
                  ...
                  child: Column(
                    children: [
                      ...
                      SingleChildScrollView(
                          ...
                          child: Row(
                            children: <Widget>[
                              for(var j=0;j<snapshot.data!.data.mentees.length;j++)
                                GestureDetector(
                                  ...
                                  child: Card(
                                    ...
                                    child: Column(
                                      ...
                                      children: <Widget>[
                                        Image(
                                            image: NetworkImage("${snapshot.data!.data.mentees[j].img.toString()}"),
                                            height: 150,
                                            width: 110),
                                        Padding(
                                          padding: const EdgeInsets.fromLTRB(8, 5, 8, 5),
                                            ...
                                            child: Column(
                                              ...
                                              children: [
                                                ...
                                                Row(
                                                  mainAxisAlignment: MainAxisAlignment.start,
                                                  children: [
                                                    Text("${snapshot.data!.data.mentees[j].name}",
                                                        style: TextStyle(
                                                            fontSize: 15,
                                                            fontFamily: "Candara",
                                                            color: Colors.grey))
